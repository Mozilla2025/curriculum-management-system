  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-lg md:text-xl font-semibold text-gray-900">Workflow Bottlenecks</h2>
        ...
        {bottlenecks.map((bottleneck) => {
          ...
          return (
            <div
              key={bottleneck.id}
              className={cn(
                'flex items-center justify-between p-3 rounded-lg border-l-4 transition-all duration-300',
                styles.bg,
                styles.border
              )}
            >
