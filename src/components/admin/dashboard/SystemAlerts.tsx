  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl md:text-2xl font-semibold text-gray-900">System Alerts</h2>
              ...
              >
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className={cn('font-semibold text-base mb-1', styles.title)}>
                      {alert.title}
                    </div>
                    <div className={cn('text-sm mb-3', styles.description)}>
                      {alert.description}
                    </div>
                    <div className="flex items-center gap-2">
                      <button className="text-sm font-medium text-must-green hover:underline">
