  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <span className="text-sm font-semibold text-gray-900">{program.name} Programs</span>
        <span className={cn('px-2 py-1 rounded-full text-xs font-semibold text-white shadow-soft', programColors[program.type])}>
          {program.count}
        </span>
      </div>
